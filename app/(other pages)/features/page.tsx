        ...
        <div className="min-h-screen bg-white text-black">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-10">
                <div className="text-center">
                    ...
                    <h2 className="text-4xl sm:text-6xl font-bold text-[#383838]">features</h2>
                </div>
            </div>

            <Features />

            <div className="w-full py-20 px-5  mt-10">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    <div className="space-y-4 p-6 rounded-2xl bg-white border border-gray-400 hover:border-gray-400 transition-all">
