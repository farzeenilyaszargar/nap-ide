    ...
    <div className="min-h-screen flex flex-col bg-[#07090D] text-[#E5E7EB]">
      ...
      <div className="bg-[#07090D] py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-[#F3F4F6] mb-4">Terms and Conditions</h1>
      ...
      <div className="flex-1 max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">2. License Grant</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">4. Subscription and Payments</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">5. Intellectual Property</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">6. Disclaimer of Warranties</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">7. Limitation of Liability</h2>
            <p className="text-[#B8C0CC] leading-relaxed">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">8. Contact Information</h2>
            <p className="text-[#B8C0CC] leading-relaxed">
              If you have any questions about these Terms, please contact us at <a href="mailto:support@napeditor.com" className="text-[#E5E7EB] underline-offset-4 hover:underline">support@napeditor.com</a> or through our <a href="/support" className="text-[#E5E7EB] underline-offset-4 hover:underline">support page</a>.
            </p>
          </section>
