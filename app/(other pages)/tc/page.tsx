        ...
        <div className="space-y-8">
          ...
          <section className="rounded-2xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              By accessing, downloading, installing, or using Nap ("the Nap app") or visiting our website at nap-code.com ("the site"), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, please do not use our app or Website.
            </p>
            <p className="text-gray-600 leading-relaxed">
              These Terms constitute a legally binding agreement between you and Nap ("we," "us," or "our"). We reserve the right to modify these Terms at any time, and such modifications will be effective immediately upon posting on our site.
            </p>
          </section>
          ...
          <section className="rounded-2xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Subject to your compliance with these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to download, install, and use the Nap app for your personal or commercial development purposes.
            </p>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
              <li>You may install the Nap app on multiple devices that you own or control</li>
              <li>You may use the Nap app for both personal and commercial projects</li>
              <li>You may not redistribute, sublicense, or resell the Nap app</li>
          ...
          <section className="rounded-2xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              To access certain features of the Nap app, you may be required to create an account. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.
            </p>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="rounded-2xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Some features of the Nap app require a paid subscription. By subscribing to a paid plan, you agree to pay all applicable fees as described on our pricing page. All fees are non-refundable except as expressly stated in these Terms.
            </p>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="rounded-2xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              You retain all rights to the code and content you create using the Nap app. We do not claim any ownership over your work product.
            </p>
          </section>
          ...
          <section className="rounded-2xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              We do not warrant that the Nap app will be uninterrupted, error-free, or completely secure. You use the Nap app at your own risk.
            </p>
          </section>
