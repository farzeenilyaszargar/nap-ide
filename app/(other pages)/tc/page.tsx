    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-black mb-4">Terms and Conditions</h1>
      ...
      <div className="flex-1 max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <section className="bg-gray-50 rounded-2xl border border-gray-200 p-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              If you have any questions about these Terms, please contact us at <a href="mailto:legal@surferseditor.com" className="text-blue-600 hover:underline">legal@surferseditor.com</a> or through our <a href="/support" className="text-blue-600 hover:underline">support page</a>.
            </p>
          </section>
