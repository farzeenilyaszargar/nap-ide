      ...
      <div className="max-w-7xl mx-auto px-4 py-20 flex flex-col items-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 w-full max-w-4xl">
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 flex flex-col items-center text-center hover:border-gray-400 transition-all">
            <Image src="/apple-icon.png" alt="macOS" width={64} height={64} className="mb-6 invert" />
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 flex flex-col items-center text-center hover:border-gray-400 transition-all">
            <Image src="/windows-icon.png" alt="Windows" width={64} height={64} className="mb-6 invert" />
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 flex flex-col items-center text-center hover:border-gray-400 transition-all">
            <Image src="/linux-icon.png" alt="Linux" width={64} height={64} className="mb-6 invert" />
