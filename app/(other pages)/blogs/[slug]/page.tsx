...
export async function generateMetadata(
    ...
    return {
        ...
        alternates: { canonical: `https://nap-code.com/blogs/${blog.slug}` },
        openGraph: {
            title: `Nap | ${blog.title}`,
            description: blog.excerpt,
            url: `https://nap-code.com/blogs/${blog.slug}`,
            type: "article",
                    ...
                    __html: JSON.stringify({
                        ...
                        itemListElement: [
                            ...
                            },
                            {
                                ...
                                position: 2,
                                name: "Blogs",
                                item: "https://nap-code.com/blogs",
                            },
                            {
                                "@type": "ListItem",
                                position: 3,
                                name: blog.title,
                                item: `https://nap-code.com/blogs/${blog.slug}`,
                            },
                        ],
                    }),
                }}
