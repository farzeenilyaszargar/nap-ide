...
export default function Privacy() {
  return (
    <div className="min-h-screen flex flex-col bg-[#07090D] text-[#E5E7EB]">
      ...
      {/* Hero Section */}
      <div className="bg-[#07090D] py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-[#F3F4F6] mb-4">Privacy Policy</h1>
          <p className="text-[#B8C0CC]">Last updated: January 3, 2026</p>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">1. Information We Collect</h2>
            ...
            <h3 className="text-lg font-semibold text-[#F3F4F6] mb-2">Personal Information:</h3>
            <ul className="list-disc list-inside text-[#B8C0CC] space-y-2 ml-4 mb-4">
            ...
            <h3 className="text-lg font-semibold text-[#F3F4F6] mb-2">Usage Information:</h3>
            <ul className="list-disc list-inside text-[#B8C0CC] space-y-2 ml-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">2. How We Use Your Information</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">3. Your Code and Data Privacy</h2>
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">4. Data Sharing</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">5. Data Security</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">6. Your Rights</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
            ...
            <p className="text-[#B8C0CC] leading-relaxed mt-4">
              To exercise these rights, please contact us at <a href="mailto:support@napeditor.com" className="text-[#E5E7EB] underline-offset-4 hover:underline">support@napeditor.com</a>.
            </p>
          </section>

          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">7. Cookies and Tracking</h2>
            <p className="text-[#B8C0CC] leading-relaxed mb-4">
          ...
          <section className="bg-[#0C1016] rounded-2xl border border-white/10 p-8">
            <h2 className="text-2xl font-bold text-[#F3F4F6] mb-4">8. Contact Us</h2>
            <p className="text-[#B8C0CC] leading-relaxed">
              If you have any questions about this Privacy Policy or our data practices, please contact us at <a href="mailto:support@napeditor.com" className="text-[#E5E7EB] underline-offset-4 hover:underline">support@napeditor.com</a> or visit our <a href="/support" className="text-[#E5E7EB] underline-offset-4 hover:underline">support page</a>.
            </p>
          </section>
