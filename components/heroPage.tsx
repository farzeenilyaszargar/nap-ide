...
export default function HeroPage() {
    ...
    return (
        <section className='mx-auto flex w-full max-w-7xl flex-col items-center gap-8 px-4 pb-6 pt-14 sm:gap-12 sm:px-6 sm:pb-8 sm:pt-16 sm:mt-8 lg:px-10 overflow-x-hidden'>
            <div className='flex w-full flex-col items-start gap-6 sm:items-center sm:gap-8'>
                ...
                <div className='flex w-full items-center justify-start sm:justify-center'>
                    ...
                    >
                        See Features
                        <Image src="/right-arrow.png" width={14} height={14} alt='arrow' className='invert opacity-100 sm:invert-0 sm:opacity-60' />
                    </Link>
                </div>
