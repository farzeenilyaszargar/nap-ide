  ...
  return (
    <section className="mx-auto flex w-full max-w-7xl flex-col px-5 pb-8 pt-10 sm:px-10 lg:px-14">
      <div className="fade-up-delay mx-auto mt-4 max-w-4xl text-center">
        <h1 className="text-4xl font-semibold leading-tight text-zinc-700 sm:text-5xl lg:text-6xl">
          Code.
        </h1>
        <h1 className="mt-1 text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
