    ...
    return (
        <section className='mx-auto flex w-full max-w-6xl flex-col items-center gap-8 px-4 pb-6 pt-14 sm:gap-0 sm:px-6 sm:pb-8 sm:pt-16 sm:mt-20 lg:px-10 overflow-x-hidden'>
            ...
            <div className='flex w-full items-center justify-start overflow-visible sm:justify-center'>
                <div className='mr-auto w-[160%] max-w-none sm:mr-0 sm:w-[120%] sm:max-w-none'>
                    <Image src={"/new-main.png"} width={1280} height={720} alt='demo' className='w-full rounded-md sm:rounded-md min-h-[520px] object-cover object-left sm:min-h-0' />
                </div>
            </div>
