        ...
        <section className='mx-auto flex w-full max-w-7xl flex-col items-center gap-8 px-4 pb-6 pt-8 sm:gap-12 sm:px-6 sm:pb-8 sm:pt-16 lg:px-10'>
            <div className='flex w-full flex-col items-center gap-6 sm:gap-8'>
                <div className='flex flex-col gap-3 sm:gap-6'>
                    ...
                    <h2 className='-mt-1 text-center text-4xl font-bold sm:-mt-4 sm:text-6xl'><span className='text-[#696969]'>Lightning.</span><span className='text-[#A4A4A4]'>Fast.</span></h2>
                </div>
