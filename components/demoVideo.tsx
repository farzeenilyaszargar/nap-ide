export default function DemoVid() {
    return (
        <div className="w-screen min-h-screen flex justify-center items-center px-6 py-10">
            <div className="bg-gray-50 border border-gray-200 rounded-xl w-full max-w-6xl min-h-[90vh] flex flex-col justify-center items-center px-8 py-12 text-black gap-6 ">
