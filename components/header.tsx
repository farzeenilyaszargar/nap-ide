...
export default function Header() {
    ...
    return (
        <>
            <header className={`w-full bg-transparent backdrop-blur-md transition-transform duration-300 sm:fixed sm:top-0 sm:left-0 sm:right-0 sm:z-20 ${isHidden ? '-translate-y-full' : 'translate-y-0'}`}>
                <div className="mx-auto flex h-14 w-full max-w-7xl items-center justify-start px-5 lg:px-10">
                    ...
                    <div className="ml-auto hidden items-center gap-6 sm:flex">
                        ...
                        <Link
                            href="/download"
                            className="flex items-center gap-2 rounded-full border border-black bg-black px-3 py-1 text-white transition-colors hover:bg-white hover:text-black hover:border-black"
                        >
                            Download
                        </Link>
                    </div>
