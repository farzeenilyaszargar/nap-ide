            ...
            <header className="sticky top-0 z-20 w-full bg-transparent backdrop-blur-md">
                ...
                <div className="flex justify-center items-center gap-3">
                    ...
                    {loading ? (
                        ...
                        <Link
                            href="/download"
                            className="group hidden sm:flex items-center gap-1 rounded-md border border-black bg-black px-3 py-1 text-white transition-colors hover:bg-white hover:text-black hover:border-black"
                        >
                            Download
                        </Link>
                    )}
