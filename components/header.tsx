...
export default function Header() {
    ...
    return (
        <>
            <header className={`w-full bg-white/50 backdrop-blur-md transition-transform duration-300 sm:fixed sm:top-0 sm:left-0 sm:right-0 sm:z-20 ${isHidden ? '-translate-y-full sm:translate-y-0' : 'translate-y-0'}`}>
