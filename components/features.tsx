...
export default function Features() {
    return (
        <section id="features" className="w-full overflow-hidden py-5 sm:py-10">
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 sm:gap-30 sm:px-6 lg:px-10">
                <h2 className="sr-only">Features</h2>
                <div className="flex flex-col gap-6 sm:gap-15">
                    <div className="flex flex-col gap-6 bg-[#F5F5F5] rounded-md sm:rounded-lg p-7 text-left overflow-hidden md:flex-row md:items-center">
