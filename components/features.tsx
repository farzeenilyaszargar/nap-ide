        ...
        <section id="features" className="w-full overflow-hidden py-5 sm:py-10">
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 sm:gap-10 sm:px-6 lg:px-10">
                ...
                <div className="flex flex-col gap-6 sm:gap-10">
                    <div className="flex flex-col bg-[#F5F5F5] rounded-sm sm:rounded-lg p-6 sm:p-15 gap-5 text-left overflow-hidden">
                        ...
                        <Image src="/parallel.jpeg" width={2000} height={2000} alt="img" className="h-64 w-full max-w-none rounded-md object-cover object-left sm:h-[420px] sm:rounded-md" />
                    </div>
                    <div className="flex flex-col bg-[#1A1A1A] rounded-sm sm:rounded-lg p-6 sm:p-15 gap-5 text-left overflow-hidden">
                        <Image src="/files.jpeg" width={2000} height={2000} alt="img" className="h-64 w-full max-w-none rounded-md object-cover object-left sm:h-[420px] sm:rounded-md" />
                    ...
                    <div className="flex flex-col gap-5 text-left">
                        <div className="overflow-hidden rounded-md sm:rounded-md">
                            <Image
                                ...
                                className="h-64 w-full max-w-none object-cover object-left sm:h-[420px] sm:rounded-md"
                                width={800}
                                height={600}
                            />
                        </div>
