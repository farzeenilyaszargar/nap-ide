...
export default function Features() {
    return (
        <section className="w-full py-10 sm:py-10 flex flex-col gap-10 sm:gap-10 overflow-hidden lg:px-20 sm:px-10">

            <div className="flex flex-col md:flex-row gap-6 sm:gap-0">
                <div className="flex flex-col mx-4 sm:m-10 sm:mr-5 bg-[#F5F5F5] rounded-2xl p-6 sm:p-15 gap-7 text-center">
                    <p className="text-2xl sm:text-4xl font-bold text-[#7E7E7E]">For the <span className="text-[#414141]">Real Devs</span>  <br></br>Nap is the best way to <span className="text-[#414141]">Code.</span></p>
                ...
                <div className="flex flex-col mx-4 sm:m-10  sm:ml-5 bg-[#1A1A1A] rounded-2xl p-6 sm:p-15 gap-7 text-center">
                    <Image src="/files.jpeg" width={2000} height={2000} alt="img" className="rounded-2xl" />
                    <p className="text-2xl sm:text-4xl font-bold text-[#EAEAEA]">Nap edits <span className="text-[#6D6D6D]">multiple files at a time</span>  so relax <span className="text-[#6D6D6D]">&amp; take a Nap.</span></p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 sm:gap-5">
                ...
                <div className="md:w-1/2 w-full px-5 text-left">
                    <h2 className="text-2xl sm:text-4xl font-bold mb-4 text-black">Control Anything &amp; Everything on Nap.</h2>
