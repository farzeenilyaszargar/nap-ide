                ...
                <div className="flex flex-col gap-6 sm:gap-10">
                    <div className="flex flex-col gap-6 bg-[#F5F5F5] rounded-sm sm:rounded-lg p-6 sm:p-15 text-left overflow-hidden md:flex-row md:items-center">
                        ...
                        <Image
                            ...
                            height={2000}
                            alt="img"
                            className="h-64 w-full max-w-none rounded-md object-cover object-left sm:h-[420px] sm:rounded-md md:h-[360px] md:w-2/3"
                        />
                    </div>
                    <div className="flex flex-col gap-6 bg-[#1A1A1A] rounded-sm sm:rounded-lg p-6 sm:p-7 text-left overflow-hidden md:flex-row md:items-center">
                        <Image
                            src="/files.jpeg"
                            width={2000}
                            height={2000}
