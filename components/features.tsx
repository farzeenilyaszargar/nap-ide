...
export default function Features() {
    return (
        <section className="w-full overflow-hidden py-10 sm:py-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 sm:gap-0">
                <div className="flex flex-col not-last:sm:mr-5 bg-[#F5F5F5] rounded-2xl p-6 sm:p-15 gap-7 text-center">
                ...
                <div className="flex flex-col sm:ml-5 bg-[#1A1A1A] rounded-2xl p-6 sm:p-15 gap-7 text-center">
